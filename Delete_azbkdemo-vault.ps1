...
$VaultName = "azbkdemo-vault" #fetch automatically
$Subscription = "MCAPS-Hybrid-REQ-52833-2023-joshikunal" #fetch automatically
$ResourceGroup = "azbkdemo-rg" #fetch automatically
$SubscriptionId = "93dab153-f48b-4313-b1dc-fb834325ad6e" #fetch automatically
